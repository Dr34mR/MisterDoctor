...
public class MainViewViewModel: ViewModelBase
    {
        ...
        private void GetSearchTerms()
        {
            ...
            var tabs = new List<TabItem>
            {
                ...
                {
                    Header = "Channel",
                    PageType = "ChannelViewModel",
                    Description = "View the channel and its chat"
                },
                new TabItem
                {
                    Header = "Plugins",
                    PageType = "PluginsViewModel",
                    Description = "Configure Plugins"
                },
                new TabItem
                {
                    Header = "Options",
                    PageType = "OptionsViewModel",
                    Description = "Configure Twitch Bot"
                },
            };
            ...
            foreach(var tab in tabs)
            {
                ...
                if (tab.Header == "MenuFlyout")
                {
                    MainSearchItems.Add(new MainAppSearchItem($"{tab.Header}", Type.GetType($"AvaloniaMisterDoctor.Views.{tab.PageType}")));
                }
                else
                {
                    MainSearchItems.Add(new MainAppSearchItem(tab.Header, Type.GetType($"AvaloniaMisterDoctor.Views.{tab.PageType}")));
